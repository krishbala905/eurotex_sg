...
class WalletCardDetailFragment extends StatefulWidget {
  late WalletmodelNew object1;
   WalletCardDetailFragment(this.object1, {Key? key}) : super(key: key);

  @override
  State<WalletCardDetailFragment> createState() => _WalletCardDetailFragmentState( object1);
}

class _WalletCardDetailFragmentState extends State<WalletCardDetailFragment> {
  WalletmodelNew object1;

  bool ShowDescription = true;
  bool Showdescription = true;
  bool ShowTermsTxt = true;
  _WalletCardDetailFragmentState(this.object1);
